...
#define SPA_DATA_FLAG_HUGE_PAGES (1u<<28)	/**< storage is backed by huge pages */
#define SPA_DATA_FLAG_HUGE_2MB	 (1u<<29)	/**< huge-page size is 2 MiB */
#define SPA_DATA_FLAG_HUGE_1GB	 (1u<<30)	/**< huge-page size is 1 GiB */
